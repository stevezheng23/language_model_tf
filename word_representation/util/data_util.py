...
def process_input_data(input_data,
    ...
    for i, sentence in enumerate(input_data):
        ...
        if subword_feat_enable is True:
            subword_feat = process_subword(words, word_max_length,
                subword_max_length, word_sos, word_eos, subword_sos,
                subword_eos, subword_pad, subword_size, subword_vocab)
...
def prepare_data(logger,
    ...
    if input_data is not None:
        (word_feat_data, subword_feat_data, char_feat_data, word_vocab,
            ...
            word_sos, word_eos, word_pad, subword_max_length, subword_feat_enable, subword_sos, subword_eos,
            subword_pad, subword_size, char_max_length, char_feat_enable, char_sos, char_eos, char_pad)
